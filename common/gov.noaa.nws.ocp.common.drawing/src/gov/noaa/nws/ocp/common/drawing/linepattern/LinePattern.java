...
public class LinePattern implements ISerializableObject {
    ...
    private List<PatternSegment> segments;
     ...
     *            Segment
     */
    public LinePattern(String name, List<PatternSegment> segments,
        ...
        if (this.arrowHeadType == null && this.arrowHead) {
    ...
    public LinePattern(String name, boolean arrowHead,
        ...
        this(name, new ArrayList<>(), arrowHead, arrowHeadType, false);
     ...
     * @param segments
     */
    public void setSegments(List<PatternSegment> segments) {
        this.segments = segments;
