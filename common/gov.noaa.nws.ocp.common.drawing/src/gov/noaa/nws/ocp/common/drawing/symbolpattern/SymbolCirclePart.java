...
/**
 * This class defines a circle part of a symbol pattern. The circle area is
 * defined by the center coordinate and the radius. The actual coordinate points
 * that make up the circle's path are calculated from the center point and
 * radius. The coordinates used for the pattern assume that the center of the
...
public class SymbolCirclePart implements ISymbolPart {
    ...
    /**
     * Constructor used to create a symbol part representing a dot (or circle)
     * at the specified center with the specified radius
     *
     * @param center
     *            center point of the dot/circle
     * @param radius
     *            radius of the dot/circle
     * @param filled
     *            flag indicating whether part shuold be filled
     */
    ...
    /**
     * Calculates the coordinates defining the arc of the circle from the center
     * point and radius.
     */
