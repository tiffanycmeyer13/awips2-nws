...
public abstract class BPGeography {
    ...
    /**
     * List of lat/lon coordinate pairs that are used to draw/display the
     * breakpoint area or segment
     */
    ...
    /**
     * @param paths
     *            the lat/lon coordinate paths to set
     */
     ...
     *
     * @param coords
     *            lat/lon coordinate pairs defining a path
     */
    ...
    /**
     * @param zones
     *            the list of land zone codes to set
     */
    ...
    /**
     * @param zones
     *            the list of land zones to add to the current list
     */
