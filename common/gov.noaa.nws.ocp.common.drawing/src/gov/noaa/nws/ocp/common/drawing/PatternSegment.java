...
/**
 * A segment of a LinePattern. Repeat PatternSegments can be applied to a line
 * path to create a pattern.
 *
 * <pre>
 * SOFTWARE HISTORY
...
public class PatternSegment {
    ...
    public enum PatternType {
        ...
        CIRCLE_FILLED,
        ARC_180_DEGREE,
        ARC_180_DEGREE_FILLED,
        ARC_180_DEGREE_CLOSED,
        ARC_90_DEGREE,
        ARC_270_DEGREE,
        ARC_270_DEGREE_WITH_LINE,
        BOX,
        BOX_FILLED,
        X_PATTERN,
        Z_PATTERN,
    ...
    /**
     * The number of individual segments to calculate around the circumference
     * of an arc. Used in the ARC Patterns.
     */
    @XmlAttribute
    private int numberInArc;

    /**
     * Pattern size (or number of pixels) to the left and right of the center
     * line segment. Used in patterns such as BOX, X, Z, Tick, and Double Line.
     */
    @XmlAttribute
    private int offsetSize;

    /**
     * By default, patterns are applied to the left side of the line path.
     * reverseSide set to true, applies patterns to the right side.
     */
    @XmlAttribute
     ...
     * 
     * @param length
     *            Length of pattern segment.
     * @param attribute
     *            Type of pattern segment.
     * @param colorLocation
     *            Index of color to use with segment.
     * @param numberInArc
     *            Number of arc segemnts to use in ARC and CIRCLE Patterns.
     * @param offsetSize
     *            Number of pixels for pattern left and right of center line.
     * @param reverseSide
     *            Apply pattern to right side of line instead of the default
     *            left.
     */
    public PatternSegment(double length, PatternType attribute,
            int colorLocation, int numberInArc, int offset,
            boolean reverseSide) {
        super();
        this.length = length;
     ...
     *         Otherwise, return false to apply pattern to the default left
     *         side.
     */
    ...
    /**
     * Set whether pattern should be applied to right side (true) of line path
     * or left side (false).
     * 
     * @param reverseSide
     */
    ...
    public PatternSegment copy() {
        ...
        return new PatternSegment(length, attribute, colorLocation, numberInArc,
                offsetSize, reverseSide);
    }
