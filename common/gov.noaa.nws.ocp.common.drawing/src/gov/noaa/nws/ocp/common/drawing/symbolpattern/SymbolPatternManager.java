...
/**
 * This class maintains a HashMap of defined Symbol Patterns that can be applied
 * to a displayable symbol at a given location.
 * <P>
 * This class is implemented as a singleton, and the predefined Symbol Patterns
...
public class SymbolPatternManager {
    ...
    private static final IUFStatusHandler logger = UFStatus
            .getHandler(SymbolPatternManager.class);

    /**
     * A map of the available Symbol Patterns with a descriptive String as the
     * key.
     */
    private Map<String, SymbolPattern> patternMap;
    ...
    /**
     * Static method used to request the instance of the SymbolPatternList
     * object.
     *
     ...
     *
     * @param key
     *            the name/description of the SymbolPattern desired.
    ...
    public SymbolPattern getSymbolPattern(String key)
        ...
        if (pattern == null) {
            throw new SymbolPatternException(
                    "Could not find symbol pattern: " + key);
        }
        return pattern;
    }
    ...
    /**
     * Constructs the HashMap holding all these internally defined
     * SymbolPatterns.
     *
     */
    private void loadInternal() {
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 0.0),
                new Coordinate(3.0, 0.0) });
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 3.0),
                new Coordinate(0.0, -3.0) });
        patternMap.put("PLUS_SIGN", sp);

        sp = new SymbolPattern("Octagon");
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -3.0),
                new Coordinate(1.0, -3.0), new Coordinate(3.0, -1.0),
                new Coordinate(3.0, 1.0), new Coordinate(1.0, 3.0),
                new Coordinate(-1.0, 3.0), new Coordinate(-3.0, 1.0),
                new Coordinate(-3.0, -1.0), new Coordinate(-1.0, -3.0) });
        patternMap.put("OCTAGON", sp);

        sp = new SymbolPattern("Triangle");
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, -3.0),
                new Coordinate(3.0, -3.0), new Coordinate(0.0, 3.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, -2.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(0.0, -3.0),
                new Coordinate(0.0, 0.0), new Coordinate(-3.0, 0.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 3.0),
                new Coordinate(3.0, 3.0), new Coordinate(-3.0, -3.0),
                new Coordinate(3.0, -3.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 0.0),
                new Coordinate(2.0, 0.0) });
        patternMap.put("Z_WITH_BAR", sp);

        sp = new SymbolPattern("Letter Y");
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 3.0),
                new Coordinate(0.0, 0.0), new Coordinate(0.0, -3.0) });
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 0.0),
                new Coordinate(3.0, 3.0) });
        patternMap.put("Y", sp);

        sp = new SymbolPattern("Box X");
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -1.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 3.0),
                new Coordinate(-1.0, 1.0), new Coordinate(-3.0, 1.0),
                new Coordinate(-1.0, 0.0), new Coordinate(-2.0, -2.0),
                new Coordinate(0.0, -1.0), new Coordinate(2.0, -2.0),
                new Coordinate(1.0, 0.0), new Coordinate(3.0, 1.0),
                new Coordinate(1.0, 1.0), new Coordinate(0.0, 3.0) });
        patternMap.put("STAR", sp);

        sp = new SymbolPattern("Dot");
        sp.addPath(
                new Coordinate[] { new Coordinate(0.5, 0.0),
                        new Coordinate(0.35, 0.35), new Coordinate(0.0, 0.5),
                        new Coordinate(-0.35, 0.35), new Coordinate(-0.5, 0.0),
                        new Coordinate(-0.35, -0.35), new Coordinate(0.0, -0.5),
                        new Coordinate(0.35, -0.35), new Coordinate(0.5, 0.0) },
                true);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -3.0),
                ...
                new Coordinate(3.0, 1.0), new Coordinate(1.0, 3.0),
                new Coordinate(-1.0, 3.0), new Coordinate(-3.0, 1.0),
                new Coordinate(-3.0, -1.0), new Coordinate(-1.0, -3.0) }, true);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-3.0, -3.0),
                        new Coordinate(3.0, -3.0), new Coordinate(3.0, 3.0),
                        new Coordinate(-3.0, 3.0), new Coordinate(-3.0, -3.0) },
                true);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(0.0, -3.0),
                        new Coordinate(-3.0, 0.0), new Coordinate(0.0, 3.0),
                        new Coordinate(3.0, 0.0), new Coordinate(0.0, -3.0) },
                true);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, -1.0),
                new Coordinate(-3.0, 0.0), new Coordinate(-2.0, 1.0),
                ...
                new Coordinate(2.0, 1.0), new Coordinate(-1.0, -2.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, -2.0),
        ...
        sp = new SymbolPattern(
                "Continuous drizzle, slight at observation time"); // Wx51
        sp.addDot(new Coordinate(-2.0, 1.0), 0.75);
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, 1.0),
                new Coordinate(-2.0, 0.0), new Coordinate(-3.0, -1.0) });
        sp.addDot(new Coordinate(2.0, 1.0), 0.75);
        sp.addPath(new Coordinate[] { new Coordinate(2.0, 1.0),
                new Coordinate(2.0, 0.0), new Coordinate(1.0, -1.0) });
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-4.0, -2.0),
                new Coordinate(-5.0, -1.0), new Coordinate(-5.0, 0.0),
                new Coordinate(-5.0, 1.0), new Coordinate(-4.0, 2.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-4.0, -1.0),
                new Coordinate(-2.0, 1.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-4.0, 1.0),
                new Coordinate(-2.0, -1.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-5.0, 0.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-4.0, 0.0),
                new Coordinate(-2.0, -2.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-4.0, -2.0),
                new Coordinate(-2.0, 0.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-5.0, -1.0),
                new Coordinate(-1.0, -1.0) });
        sp.addPath(new Coordinate[] { new Coordinate(2.0, 0.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 4.0),
                new Coordinate(1.0, 2.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 2.0),
                new Coordinate(1.0, 4.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, 3.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, -2.0),
                new Coordinate(0.0, 3.0), new Coordinate(3.0, -2.0),
                new Coordinate(-3.0, -2.0) });
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 1.0),
                new Coordinate(0.0, -5.0), new Coordinate(3.0, 1.0),
                new Coordinate(-3.0, 1.0) });
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 5.0),
                new Coordinate(1.0, 3.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, 4.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 1.0),
                new Coordinate(0.0, -5.0), new Coordinate(3.0, 1.0),
                new Coordinate(-3.0, 1.0) }, false);
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 2.0),
                new Coordinate(0.0, 4.0), new Coordinate(3.0, 2.0),
                new Coordinate(-3.0, 2.0) }, false);
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, -1.0),
                new Coordinate(2.0, -1.0) }, false);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-3.0, 2.0),
                new Coordinate(0.0, 4.0), new Coordinate(3.0, 2.0),
                new Coordinate(-3.0, 2.0) }, true);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 4.0),
                new Coordinate(0.0, 2.0) }, false);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, 1.0),
                new Coordinate(2.0, 1.0), new Coordinate(0.0, -1.0),
                new Coordinate(3.0, -4.0), new Coordinate(3.0, -3.0),
                new Coordinate(3.0, -4.0), new Coordinate(2.0, -4.0) });
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -4.0),
                new Coordinate(-1.0, 1.0) }, false);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -4.0),
                new Coordinate(-4.0, -4.0), new Coordinate(-2.0, 1.0),
                new Coordinate(2.0, 1.0), new Coordinate(4.0, -4.0),
                new Coordinate(1.0, -4.0) });
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 1.0),
                new Coordinate(-2.0, 4.0) }, false);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 1.0),
                new Coordinate(0.0, 4.0) }, false);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 1.0),
                new Coordinate(2.0, 4.0) }, false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 4.0),
                        new Coordinate(-2.0, 4.0), new Coordinate(-2.0, 1.0),
                        new Coordinate(2.0, 1.0), new Coordinate(2.0, 4.0),
                        new Coordinate(4.0, 4.0), new Coordinate(4.0, -5.0),
                        new Coordinate(2.0, -5.0), new Coordinate(2.0, -1.0),
                        new Coordinate(-2.0, -1.0), new Coordinate(-2.0, -5.0),
                        new Coordinate(-4.0, -5.0), new Coordinate(-4.0, 4.0) },
                true);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 4.0),
                        new Coordinate(-2.0, 4.0), new Coordinate(-2.0, -3.0),
                        new Coordinate(4.0, -3.0), new Coordinate(4.0, -5.0),
                        new Coordinate(-4.0, -5.0), new Coordinate(-4.0, 4.0) },
                true);
        patternMap.put("LOW_PRESSURE_L", sp);

        sp = new SymbolPattern("Tropical Storm (Northern Hemisphere)"); // Sp25
        sp.addPath(new Coordinate[] { new Coordinate(2.0, 5.0),
                new Coordinate(1.0, 5.0), new Coordinate(-1.0, 4.0),
                new Coordinate(-2.0, 2.0), new Coordinate(-2.0, 0.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, -5.0),
                ...
                new Coordinate(-2.0, -5.0) }, true);
        sp.addPath(
                new Coordinate[] { new Coordinate(-1.0, 2.0),
                        new Coordinate(-2.0, 1.0), new Coordinate(-2.0, 0.0),
                        new Coordinate(-1.0, -2.0), new Coordinate(1.0, -2.0),
                        new Coordinate(2.0, -1.0), new Coordinate(2.0, 0.0),
                        new Coordinate(1.0, 2.0), new Coordinate(-1.0, 2.0) },
                false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(2.0, 5.0),
                        new Coordinate(1.0, 5.0), new Coordinate(-1.0, 4.0),
                        new Coordinate(-2.0, 2.0), new Coordinate(-2.0, 0.0),
                        new Coordinate(-1.0, -2.0), new Coordinate(1.0, -2.0),
                        new Coordinate(0.0, -4.0), new Coordinate(-2.0, -5.0),
                        new Coordinate(-1.0, -5.0), new Coordinate(1.0, -4.0),
                        new Coordinate(2.0, -2.0), new Coordinate(2.0, 0.0),
                        new Coordinate(1.0, 2.0), new Coordinate(-1.0, 2.0),
                        new Coordinate(0.0, 4.0), new Coordinate(2.0, 5.0) },
        ...
        sp.addPath(new Coordinate[] { new Coordinate(2.0, -5.0),
                new Coordinate(0.0, -5.0), new Coordinate(-2.0, -4.0),
                new Coordinate(-3.0, -2.0), new Coordinate(-3.0, 0.0),
        ...
        sp.addPath(new Coordinate[] { new Coordinate(1.0, 0.0),
                ...
                new Coordinate(1.0, 0.0) }, true);
        sp.addPath(
                new Coordinate[] { new Coordinate(0.0, -2.0),
                        new Coordinate(-2.0, -2.0), new Coordinate(-3.0, -1.0),
                        new Coordinate(-3.0, 0.0), new Coordinate(-2.0, 2.0),
                        new Coordinate(0.0, 2.0), new Coordinate(1.0, 1.0),
                        new Coordinate(0.0, -2.0), new Coordinate(-2.0, -2.0) },
                false);
        patternMap.put("TROPICAL_STORM_SH", sp);

        sp = new SymbolPattern("Hurricane (Southern Hemisphere)"); // Sp28
        sp.addPath(
                new Coordinate[] { new Coordinate(1.0, -5.0),
                        new Coordinate(0.0, -5.0), new Coordinate(-2.0, -4.0),
                        new Coordinate(-3.0, -2.0), new Coordinate(-3.0, 0.0),
                        ...
                        new Coordinate(1.0, 2.0), new Coordinate(1.0, 0.0),
                        new Coordinate(0.0, -2.0), new Coordinate(-2.0, -2.0),
                        new Coordinate(-1.0, -4.0), new Coordinate(1.0, -5.0) },
                true);
        patternMap.put("HURRICANE_SH", sp);

        sp = new SymbolPattern("Storm Center"); // Sp32
        sp.addPath(new Coordinate[] { new Coordinate(-5.0, -5.0),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-5.0, 1.0),
                        new Coordinate(-5.0, -1.0), new Coordinate(-4.0, -3.0),
                        new Coordinate(-3.0, -4.0), new Coordinate(-1.0, -5.0),
                        new Coordinate(1.0, -5.0), new Coordinate(3.0, -4.0),
                        new Coordinate(4.0, -3.0), new Coordinate(5.0, -1.0),
                        new Coordinate(5.0, 1.0), new Coordinate(4.0, 3.0),
                        new Coordinate(3.0, 4.0), new Coordinate(1.0, 5.0),
                        new Coordinate(-1.0, 5.0), new Coordinate(-3.0, 4.0),
                        new Coordinate(-4.0, 3.0), new Coordinate(-5.0, 1.0) },
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-5.0, 5.0),
                new Coordinate(5.0, 5.0) });
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 5.0),
                new Coordinate(0.0, -5.0) });
        sp.addPath(new Coordinate[] { new Coordinate(5.0, -4.0),
                new Coordinate(4.0, -5.0), new Coordinate(3.0, -5.0),
                new Coordinate(2.0, -4.0), new Coordinate(2.0, -2.0),
                new Coordinate(3.0, -1.0), new Coordinate(4.0, -1.0),
                new Coordinate(5.0, -2.0) }, false);
        patternMap.put("TROPICAL_CYCLONE", sp);

        sp = new SymbolPattern("Flame"); // Sp35
        sp.addPath(new Coordinate[] { new Coordinate(0.0, -5.0),
                new Coordinate(0.0, -4.0), new Coordinate(1.0, -5.0),
                new Coordinate(2.0, -3.0), new Coordinate(4.0, -2.0),
                new Coordinate(5.0, -1.0), new Coordinate(5.0, 0.0),
                new Coordinate(4.0, 2.0), new Coordinate(4.0, 1.0),
                new Coordinate(2.0, -1.0), new Coordinate(2.0, 1.0),
                new Coordinate(1.0, 5.0), new Coordinate(0.0, 3.0),
                new Coordinate(-1.0, 4.0), new Coordinate(-1.0, 3.0),
                new Coordinate(-2.0, 1.0), new Coordinate(-2.0, 0.0),
                new Coordinate(-1.0, -2.0), new Coordinate(-1.0, -1.0),
                new Coordinate(1.0, 0.0), new Coordinate(0.0, -1.0),
                new Coordinate(0.0, -3.0), new Coordinate(-3.0, -2.0),
                new Coordinate(-4.0, -1.0), new Coordinate(-5.0, 2.0),
                new Coordinate(-5.0, 0.0), new Coordinate(-4.0, -2.0),
                new Coordinate(-5.0, -1.0), new Coordinate(-5.0, -2.0),
                new Coordinate(-4.0, -3.0), new Coordinate(-5.0, -3.0),
                new Coordinate(0.0, -5.0) }, true);
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 2.0),
                        new Coordinate(-3.0, 0.0), new Coordinate(-3.0, 2.0),
                        new Coordinate(-2.0, 3.0), new Coordinate(-2.0, 4.0),
                        new Coordinate(-3.0, 3.0), new Coordinate(-3.0, 5.0),
                        new Coordinate(-4.0, 2.0), new Coordinate(-4.0, 0.0),
                        new Coordinate(-3.0, -1.0), new Coordinate(-4.0, 2.0) },
                true);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, 2.0),
                new Coordinate(2.0, -2.0) });
        sp.addPath(
                new Coordinate[] { new Coordinate(-5.0, 5.0),
                        new Coordinate(-3.0, 5.0), new Coordinate(-3.0, -3.0),
                        new Coordinate(2.0, -3.0), new Coordinate(2.0, -5.0),
                        new Coordinate(-5.0, -5.0), new Coordinate(-5.0, 5.0) },
                false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-5.0, -2.0),
                        new Coordinate(-3.0, -3.0), new Coordinate(-1.0, -2.0),
                        new Coordinate(0.0, 0.0), new Coordinate(3.0, 0.0),
                        new Coordinate(4.0, -1.0), new Coordinate(5.0, -3.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 0.0),
                new Coordinate(-1.0, 1.0), new Coordinate(-1.0, 4.0),
                new Coordinate(0.0, 5.0) }, false);
        patternMap.put("TROPICAL_STORM_NH_WPAC", sp);

        sp = new SymbolPattern("Tropical Storm SH"); // Sp40
        sp.addPath(new Coordinate[] { new Coordinate(5.0, -2.0),
                new Coordinate(3.0, -3.0), new Coordinate(1.0, -2.0),
                new Coordinate(0.0, 0.0), new Coordinate(-3.0, 0.0),
                new Coordinate(-4.0, -1.0), new Coordinate(-5.0, -3.0) },
                false);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(-5.0, 1.0),
                new Coordinate(-3.0, 5.0), new Coordinate(-1.0, 1.0),
                new Coordinate(-5.0, 1.0) }, true);
        sp.addPath(new Coordinate[] { new Coordinate(1.0, 1.0),
                new Coordinate(3.0, 5.0), new Coordinate(5.0, 1.0),
                new Coordinate(1.0, 1.0) }, true);
        sp.addPath(new Coordinate[] { new Coordinate(-2.0, -5.0),
                new Coordinate(0.0, -1.0), new Coordinate(2.0, -5.0),
                new Coordinate(-2.0, -5.0) }, true);
        ...
        sp.addPath(new Coordinate[] { new Coordinate(5.0, -5.0),
                new Coordinate(3.0, -5.0), new Coordinate(2.0, -2.0),
                new Coordinate(-2.0, -2.0), new Coordinate(-1.0, 0.0),
                new Coordinate(1.0, 0.0), new Coordinate(0.0, 3.0),
                new Coordinate(-1.0, 0.0), new Coordinate(-2.0, -2.0),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(5.0, -2.0),
                        new Coordinate(4.0, -4.0), new Coordinate(2.0, -5.0),
                        new Coordinate(-2.0, -5.0), new Coordinate(-4.0, -4.0),
                        new Coordinate(-5.0, -2.0), new Coordinate(-5.0, 2.0),
                        new Coordinate(-4.0, 4.0), new Coordinate(-2.0, 5.0),
                        new Coordinate(2.0, 5.0), new Coordinate(4.0, 4.0),
                        new Coordinate(5.0, 2.0), new Coordinate(3.0, 2.0),
                        new Coordinate(2.0, 3.0), new Coordinate(-2.0, 3.0),
                        new Coordinate(-3.0, 2.0), new Coordinate(-3.0, -2.0),
                        new Coordinate(-2.0, -3.0), new Coordinate(2.0, -3.0),
                        new Coordinate(3.0, -2.0), new Coordinate(5.0, -2.0) },
                false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(5.0, -5.0),
                        new Coordinate(3.0, -5.0), new Coordinate(0.0, -1.0),
                        new Coordinate(-3.0, -5.0), new Coordinate(-5.0, -5.0),
                        new Coordinate(-1.0, 0.0), new Coordinate(-5.0, 5.0),
                        new Coordinate(-3.0, 5.0), new Coordinate(0.0, 1.0),
                        new Coordinate(3.0, 5.0), new Coordinate(5.0, 5.0),
                        new Coordinate(1.0, 0.0), new Coordinate(5.0, -5.0) },
                false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(3.0, 4.0),
                        new Coordinate(5.0, 4.0), new Coordinate(5.0, 0.0),
                        new Coordinate(3.0, 0.0), new Coordinate(3.0, 4.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 4.0),
                new Coordinate(1.0, 4.0), new Coordinate(1.0, 0.0),
                new Coordinate(-1.0, 0.0) }, false);
        sp.addPath(
                new Coordinate[] { new Coordinate(-5.0, -2.0),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(2.0, 2.0),
                        new Coordinate(2.0, 0.0), new Coordinate(1.0, -1.0),
                        new Coordinate(-1.0, -1.0), new Coordinate(-2.0, 0.0),
                        new Coordinate(-2.0, 2.0), new Coordinate(2.0, 2.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 4.0),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(3.0, 2.0),
                        new Coordinate(3.0, 0.0), new Coordinate(2.0, -1.0),
                        new Coordinate(-2.0, -1.0), new Coordinate(-3.0, 0.0),
                        new Coordinate(-3.0, 2.0), new Coordinate(3.0, 2.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, 4.0),
                new Coordinate(-1.0, -4.0) });
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-2.0, 1.0),
                        new Coordinate(2.0, 1.0), new Coordinate(0.0, -1.0),
                        new Coordinate(3.0, -4.0), new Coordinate(3.0, -3.0),
                        new Coordinate(3.0, -4.0), new Coordinate(2.0, -4.0) },
                false);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 1.0),
                        new Coordinate(-4.0, -1.0), new Coordinate(-3.6, -2.0),
                        new Coordinate(-2.9, -2.9), new Coordinate(-2.0, -3.6),
                        new Coordinate(-1.0, -4.0), new Coordinate(1.0, -4.0),
                        new Coordinate(2.0, -3.6), new Coordinate(2.9, -2.9),
                        new Coordinate(3.6, -2.0), new Coordinate(4.0, -1.0),
                        new Coordinate(4.0, 1.0), new Coordinate(3.6, 2.0),
                        new Coordinate(2.9, 2.9), new Coordinate(2.0, 3.6),
                        new Coordinate(1.0, 4.0), new Coordinate(-1.0, 4.0),
                        new Coordinate(-2.0, 3.6), new Coordinate(-2.9, 2.9),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 1.0),
                        ...
                        new Coordinate(-3.6, 2.0), new Coordinate(-4.0, 1.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(0.0, 2.0),
                new Coordinate(0.0, -2.0) });
        ...
        sp.addPath(
                ...
                false);
        sp.addPath(
                new Coordinate[] { new Coordinate(4.0, 0.0),
                        new Coordinate(4.0, 1.0), new Coordinate(3.6, 2.0),
                        new Coordinate(2.9, 2.9), new Coordinate(2.0, 3.6),
                        new Coordinate(1.0, 4.0), new Coordinate(0.0, 4.0),
                        new Coordinate(0.0, 0.0), new Coordinate(4.0, 0.0) },
                true);
        ...
        sp.addPath(
                ...
                false);
        sp.addPath(
                new Coordinate[] { new Coordinate(0.0, -4.0),
                        new Coordinate(1.0, -4.0), new Coordinate(2.0, -3.6),
                        new Coordinate(2.9, -2.9), new Coordinate(3.6, -2.0),
                        new Coordinate(4.0, -1.0), new Coordinate(4.0, 1.0),
                        new Coordinate(3.6, 2.0), new Coordinate(2.9, 2.9),
                        new Coordinate(2.0, 3.6), new Coordinate(1.0, 4.0),
                        new Coordinate(0.0, 4.0), new Coordinate(0.0, -4.0) },
                true);
        ...
        sp.addPath(
                ...
                false);
        sp.addPath(
                new Coordinate[] { new Coordinate(0.5, -4.0),
                        new Coordinate(1.0, -4.0), new Coordinate(2.0, -3.6),
                        new Coordinate(2.9, -2.9), new Coordinate(3.6, -2.0),
                        new Coordinate(4.0, -1.0), new Coordinate(4.0, 1.0),
                        new Coordinate(3.6, 2.0), new Coordinate(2.9, 2.9),
                        new Coordinate(2.0, 3.6), new Coordinate(1.0, 4.0),
                        new Coordinate(0.5, 4.0), new Coordinate(0.5, -4.0) },
                true);
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 1.0),
                        new Coordinate(-4.0, -1.0), new Coordinate(-3.6, -2.0),
                        new Coordinate(-2.9, -2.9), new Coordinate(-2.0, -3.6),
                        new Coordinate(-1.0, -4.0), new Coordinate(-0.5, -4.0),
                        new Coordinate(-0.5, 4.0), new Coordinate(-1.0, 4.0),
                        new Coordinate(-2.0, 3.6), new Coordinate(-2.9, 2.9),
                        new Coordinate(-3.6, 2.0), new Coordinate(-4.0, 1.0) },
                true);
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-4.0, 1.0),
                        ...
                        new Coordinate(-3.6, 2.0), new Coordinate(-4.0, 1.0) },
                false);
        sp.addPath(new Coordinate[] { new Coordinate(-2.9, -2.9),
        ...
        sp.addPath(
                ...
                false);
        sp.addPath(new Coordinate[] { new Coordinate(-1.0, -3.0),
                new Coordinate(-1.0, 3.0), new Coordinate(0.0, 0.0),
        ...
        sp.addPath(
                new Coordinate[] { new Coordinate(-5.0, -3.0),
                        new Coordinate(1.0, 3.0), new Coordinate(4.0, 0.0) },
                false);
    ...
    public void savePatternsToFile(String filename) {
        ...
        try (PrintWriter writer = new PrintWriter(new File(filename))) {
            ...
            JAXBContext context = JAXBContext.newInstance(
                    SymbolPatternList.class, SymbolPatternMapEntry.class);
    ...
    /**
     * Uses JAXB to unmarshal a list of SymbolPatterns from an XML file, and
     * load them into the internal HashMap.
     *
     * @param filename
     *            input XML filename
     */
    public void loadPatternsFromFile(String filename) {
        ...
        try {
            JAXBContext context = JAXBContext
                    .newInstance(SymbolPatternList.class);
            ...
            logger.error("loadPatternsToFile(): ", e);
        }
     ...
     *            input XML filename
     */
    public void loadPatternsFromLocalization() {

        gov.noaa.nws.ocp.common.drawing.symbolpattern.SymbolPatternList spl = DrawingConfigManager
                .getInstance().getSymbolPatterns();
        if (!spl.getPatternList().isEmpty()) {

            // Add each LinePattern to hashMap
            for (gov.noaa.nws.ocp.common.drawing.symbolpattern.SymbolPatternMapEntry entry : spl
                    .getPatternList()) {
                patternMap.put(entry.getPatternId(), entry.getPattern());
            }
