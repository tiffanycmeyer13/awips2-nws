...
import gov.noaa.nws.ocp.common.drawing.PatternSegment.PatternType;
...
public class LinePatternManager {
     ...
     * key.
     */
    private Map<String, LinePattern> patternMap;
    ...
    public LinePattern getLinePattern(String key) throws LinePatternException {
        ...
        if (pattern == null) {
            throw new LinePatternException(
                    "Could not find line pattern: " + key);
        }
    ...
    private void loadInternal() {
        ...
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(
                new PatternSegment(4, PatternType.CIRCLE, 0, 8, 0, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        patternMap.put("BALL_CHAIN", lp);

        lp = new LinePattern("ZigZag", false, null);
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 2, 0,
                false));
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 2, 0,
                true));
        ...
        lp.addSegment(new PatternSegment(8, PatternType.ARC_180_DEGREE, 0, 8, 0,
                false));
        ...
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(6, PatternType.ARC_270_DEGREE, 0, 2, 0,
                false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp = new LinePattern("Filled Box-Open Box with filled arrow head", true,
                ArrowHeadType.FILLED);
        lp.addSegment(
                new PatternSegment(4, PatternType.BOX_FILLED, 0, 0, 2, false));
        ...
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(
                new PatternSegment(4, PatternType.X_PATTERN, 0, 0, 2, false));
        lp.addSegment(new PatternSegment(2, PatternType.BLANK, 0, 0, 0, false));
        lp.addSegment(new PatternSegment(4, PatternType.LINE, 0, 0, 0, false));
        ...
        lp.addSegment(
                new PatternSegment(1, PatternType.DOUBLE_LINE, 0, 0, 2, false));
        patternMap.put("DOUBLE_LINE", lp);

        lp = new LinePattern("Z-Line", false, null);
        lp.addSegment(
                new PatternSegment(8, PatternType.Z_PATTERN, 0, 0, 2, false));
        ...
        lp.addSegment(new PatternSegment(12, PatternType.LINE, 0, 0, 0, false));
        lp.addSegment(
                new PatternSegment(8, PatternType.ARROW_HEAD, 0, 2, 0, false));
    ...
    public void loadPatternsFromLocalization() {
        ...
        LinePatternList lpl = DrawingConfigManager.getInstance()
                .getLinePatterns();
        if (!lpl.getPatternList().isEmpty()) {
