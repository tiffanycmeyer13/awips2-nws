 ...
 * Apr 16, 2020 71986      mporricelli Tweaked CSV format and added
 *                                     sorting of b-deck records for
 *                                     creating deck files
 ...
 */
@MappedSuperclass
public class BaseBDeckRecord extends AbstractDeckRecord
     ...
     *            BaseBDeckRecord
     *
     * @return BaseBDeckRecord
     */
    public BaseBDeckRecord(BaseBDeckRecord rec) {
    ...
    public String toBDeckString() {
        ...
        sb.append((clonInt != 0 && clon > 0) || clonInt == 0 ? "E" : "W");
        sb.append(sep);
        // 25.0 -> " 25"
    ...
    /**
     * Sort records by reference time, rad wind
     *
     * @param bDeckRecs
     */
    public static void sortBDeck(List<BaseBDeckRecord> bDeckRecs) {
        if (!bDeckRecs.isEmpty()) {
            Comparator<BaseBDeckRecord> refTimeCmp = Comparator
                    .comparing(BaseBDeckRecord::getRefTime);
            Comparator<BaseBDeckRecord> radWndCmp = Comparator
                    .comparing(BaseBDeckRecord::getRadWind);
            Collections.sort(bDeckRecs, refTimeCmp.thenComparing(radWndCmp));
        }
    }
