...
/**
 * 
 * Request to update a record into climate_period table
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class UpdateClimatePeriodRequest implements IServerRequest {
    ...
    public UpdateClimatePeriodRequest() {
    }

    public UpdateClimatePeriodRequest(int stationId, int normStartYear,
