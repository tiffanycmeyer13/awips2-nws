 ...
 */
@DynamicSerialize
public class ClimateCreatorDailyResponse extends ClimateCreatorResponse {
     ...
     * Empty constructor.
     */
    public ClimateCreatorDailyResponse() {
        super();
    }
     ...
     *            report data map.
     */
    public ClimateCreatorDailyResponse(PeriodType iPeriodType,
            ClimateDate iADate,
