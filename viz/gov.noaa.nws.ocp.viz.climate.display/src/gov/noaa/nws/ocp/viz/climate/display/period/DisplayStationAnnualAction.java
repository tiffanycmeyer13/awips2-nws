...
/**
 * Display Station Annual dialog action.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class DisplayStationAnnualAction extends DisplayStationPeriodAction {

    @Override
    public Object execute(ExecutionEvent event) throws ExecutionException {
        try {
            preDisplaySelection(PeriodType.ANNUAL_RAD);
