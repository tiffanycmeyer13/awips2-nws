...
/**
 * Display Station Monthly dialog action.
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class DisplayStationMonthlyAction extends DisplayStationPeriodAction {
    @Override
    public Object execute(ExecutionEvent event) throws ExecutionException {
        try {
            preDisplaySelection(PeriodType.MONTHLY_RAD);
