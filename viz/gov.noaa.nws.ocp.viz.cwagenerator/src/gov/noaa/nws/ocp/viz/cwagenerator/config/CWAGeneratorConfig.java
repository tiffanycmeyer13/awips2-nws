...
public class CWAGeneratorConfig {
    ...
    /** State IDs */
    @XmlElement(name = "isCwsUseStateIDs")
    private boolean isCwsUseStateIDs;

    @XmlElement(name = "retainInDays")
    private int retainInDays = 15;

    @XmlElement(name = "thunderstormType")
    private String thunderstormType;
    ...
    public boolean isCwsUseStateIDs() {
        return isCwsUseStateIDs;
    }

    public void setCwsUseStateIDs(boolean isCwsUseStateIDs) {
        this.isCwsUseStateIDs = isCwsUseStateIDs;
    }

    public int getRetainInDays() {
        return retainInDays;
    }

    public void setRetainInDays(int retainInDays) {
        this.retainInDays = retainInDays;
    }

    public String getThunderstormType() {
        return thunderstormType;
    }

    public void setThunderstormType(String thunderstormType) {
        this.thunderstormType = thunderstormType;
    }
