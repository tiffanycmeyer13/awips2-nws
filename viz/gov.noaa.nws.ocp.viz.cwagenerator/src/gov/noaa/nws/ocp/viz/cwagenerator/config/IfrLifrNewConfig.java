...
/**
 * class for the IFR/LIFR configuration. The old IfrLifrConfig
 ...
 * @author wkwock
 */
public class IfrLifrNewConfig extends AbstractCWANewConfig {
    /** developing check */
     ...
     * constructor
     */
    public IfrLifrNewConfig() {

    }

    public IfrLifrNewConfig(IfrLifrConfig oldConfig) {
        super(oldConfig);
        dvlpgChk = oldConfig.isDvlpgChk();
        coverage = oldConfig.getCoverage();
        flight = oldConfig.getFlight();
        cigFrom = oldConfig.getCigFrom();
        cigTo = oldConfig.getCigTo();
        vsbyFrom = oldConfig.getVsbyFrom();
        vsbyTo = oldConfig.getVsbyTo();
        brChk = oldConfig.isBrChk();
        fgChk = oldConfig.isFgChk();
        hzChk = oldConfig.isHzChk();
        dzChk = oldConfig.isDzChk();
        raChk = oldConfig.isRaChk();
        snChk = oldConfig.isSnChk();
        fuChk = oldConfig.isFuChk();
        duChk = oldConfig.isDuChk();
        ssChk = oldConfig.isSsChk();
