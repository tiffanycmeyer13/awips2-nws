...
/**
 * This class can be used to apply several different patterns involving four
 * corner points to a specific segment of a line path. The four corner points
 * can be used to form a box, "X", "Z", or double line pattern segment.
 * <P>
 * Users can specify the pattern distance left and right of the center of the
 * line segment.
 *
 * <pre>
 * SOFTWARE HISTORY
...
public class CornerPatternApplicator extends AbstractPatternApplicator {
    ...
    /**
     * The available patterns that can be created with CornerPatternApplicator
     * class.
     */
    public enum CornerPattern {
        BOX, X_PATTERN, Z_PATTERN, DOUBLE_LINE, TICK
    }
     ...
     * the line where the corner pattern will be applied.
     *
     * @param line
     *            - Set of points Defining a line path.
     * @param startLoc
    ...
    /**
     * Sets the size, in the normal direction of the path, for the resulting
     * corner pattern.
     *
     * @param height
     *            Distance left and right of the center line. Default is 1.0
     */
     ...
     *         <P>
     *         If patternType set to BOX, the first point is repeated at the end
     *         of the array of points so that line segments connecting the point
     *         will produce a closed box.
     *         <P>
     *         If patternType set to DOUBLE_LINE, Note the first two points
     *         represent the top line, and the last two points define the bottom
     *         line segment.
     *         <P>
     *         If patternType set to Z_PATTERN, the segments defined by the
     *         points look like a "Z".
     *         <P>
     *         If patternType set to X_PATTERN, Note the first two points
     *         represent one slash of the "X", and the last two points define
     *         the other slash segment.
    ...
    public double[][] calculateLines() {
        ...
        /*
         * get line segment angle and calculate the x and y coordinate offsets
         * at right angle to the segment
         */
