...
public class DECollection extends AbstractDrawableComponent {
    ...
    /**
     * Create an iterator for DrawableElements in the collection. A collection
     * may contain collections. This iterator will loop over all
     * DrawableElements regardless their depths. Collections themselves are not
    ...
    /**
     * Get the iterator of the collection. This iterator will loop over only the
     * direct children(DrawableElements and DECollections) of the collection.
     *
     * @return
     */
    ...
    public DECollection copy() {
        ...
        dec.setElemCategory(this.getElemCategory());
        dec.setElemType(this.getElemType());
    ...
    /**
     * Deep search for the input component. Return the component's parent if
     * search succeeds. Otherwise return null.
     *
     * @param component
     * @return
     */
     ...
     * @return
     */
    private boolean replaceComponent(AbstractDrawableComponent oldEl,
            AbstractDrawableComponent newEl) {
     ...
     * @return
     */
    public boolean replace(AbstractDrawableComponent oldEl,
            AbstractDrawableComponent newEl) {
    ...
    /**
     * Finds the nearest component(DE/DECollection) in the collection to the
     * input point.
     *
     * @param point
    ...
    /**
     * Return true if the DEColloection contains the input component. The input
     * component can be a DrawableElement or a DECollection
     *
     * @param adc
     * @return
     */
        ...
        if (this.compList.contains(adc)) {
            ...
            while (it.hasNext()) {
                ...
                if (item instanceof DECollection) {
                    if (((DECollection) item).contains(adc)) {
                        return true;
                    }
                }
            }
