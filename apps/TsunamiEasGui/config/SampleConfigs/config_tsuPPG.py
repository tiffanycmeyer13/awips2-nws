...
localphrase="coastal areas of tutuila, aunuu, manua, and swains islands"
...
zone_order=[ "ASZ001", "ASZ002", "ASZ003" ] 
...
#  (should be: TSUWCA for west coast/Alaska, TSUAT1 for east coast, TSUCA1 for Caribbean,
#              TSUHWX for Hawaii, TSUGUM for Guam, or TSUPPG for American Samoa)
wcapil="TSUPPG"

#  Standard time UTZ offset in hours (omit +/- signs).
tz=11 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
tzid="sst" # standard time id (pst, ast)
