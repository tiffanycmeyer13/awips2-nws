...
localphrase="coastal areas of oahu ... kauai ... maui ... and the big island."

#  General actions for any tsunami statement. Added to the very end of the statement.
local_actions="Stay tuned to WHFO, the Pacific TWC, and NOAA weather radio for further information and updates."

# BMH PILS. What are the PILs in BMH for each WWA type.
...
zone_order=["HIZ001","HIZ003","HIZ005","HIZ007"] 
...
tz=10 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
# tzid="pst" # standard time id (pst, ast)
tzid="hst" # standard time id (pst, ast)
...
#  Note: this is configurable on the fly in the BMH Settings menu.
expiresin=60
