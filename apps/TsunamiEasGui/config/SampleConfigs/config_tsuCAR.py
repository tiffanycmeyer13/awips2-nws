...
localphrase="coastal areas of puerto rico, saint thomas, and saint croix"
...
zone_order=["PRZ001", "AMZ715", "VIZ001"]
...
tz=4 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
tzid="ast" # standard time id (pst, ast)
