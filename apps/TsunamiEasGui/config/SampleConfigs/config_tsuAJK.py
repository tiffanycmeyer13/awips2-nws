...
# comment out to disable program from sending anything to the radio. Good for testing purposes. 
nwrsend="activate"#"/awips/fxa/bin/transferNWR"
...
localphrase="coastal areas of southeastern alaska"
...
#=======
# CRS/BMH PILS. What are the PILs in CRS/BMH for each WWA type.
...
"AKZ022":"Salisbury Sound to Cape Fairweather Coastal Area",
"AKZ023":"Cape Decision to Salisbury Sound Coastal Area",
"AKZ024":"Eastern Baranof Island and Southern Admiralty Island",
"AKZ025":"Juneau Borough and Northern Admiralty Island",
"AKZ026":"Inner Channels from Kupreanof Island to Etolin Island",
"AKZ027":"Dixon Entrance to Cape Decision Coastal Area",
...
zone_order=["AKZ017","AKZ018","AKZ019","AKZ020","AKZ021","AKZ022","AKZ023","AKZ024","AKZ025","AKZ026","AKZ027","AKZ028","AKZ029"]#,"AKZ171"]

#  This is a list identifying which zones exist in each county.
#  Zones are identified by the same 6 character zone codes used in the zone_list setting
...
#  It is ok to have zones in more than one county
county_list={
        "AKZ017":"AKZ017",
        "AKZ018":"AKZ018",
        "AKZ019":"AKZ019",
...
tz=9 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
tzid="akst" # standard time id (pst, ast)
