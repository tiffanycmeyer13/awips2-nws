...
localphrase="coastal areas of saipan, tinian, and guam"
...
zone_order=["GUZ001","GUZ002","GUZ003","GUZ004", "ASZ001"] 
...
tz=14 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
tzid="chst" # standard time id (pst, ast)
