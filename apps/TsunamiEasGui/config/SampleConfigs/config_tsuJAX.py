...
localphrase="coastal areas of florida, georgia, and south carolina"
...
"FLZ077":"Key West",
"FLZ078":"Daytona",
"FLZ173":"Melbourne Beach",
"FLZ125":"Jacksonville Beach",
"GAZ154":"Savannah",
"SCZ056":"Charleston"
}
...
zone_order=[ "FLZ076", "FLZ077", "FLZ078", "FLZ173", "FLZ125", "GAZ154", "SCZ056"]
...
county_list={
"FLC001":"FLZ076,FLZ077,FLZ078",
"FLC003":"FLZ173,FLZ125",
"GAC001":"GAZ154",
"SCC001":"SCZ056"
}
...
tz=5 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
tzid="est" # standard time id (pst, ast)
