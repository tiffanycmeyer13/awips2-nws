...
#
# *** GENERATING TEXT FOR KEYWORD 'DISCLAIMER' ***
#  >>>>> THIS FILE WAS AUTOGENERATED FROM CRS DATA ON 2021-04-09 <<<<<
#  >>>>>    Please inspect and update as needed before use.     <<<<<
...
# *** GENERATING TEXT FOR KEYWORD 'NODE' ***
node = "RDU"
...
# *** GENERATING TEXT FOR KEYWORD 'ZONELIST' ***
zone_list = {
"NCZ105":"INLAND PENDER COUNTY",
"NCZ106":"COASTAL PENDER COUNTY",
"NCZ107":"INLAND NEW HANOVER COUNTY",
"NCZ108":"COASTAL NEW HANOVER COUNTY",
"NCZ110":"INLAND BRUNSWICK COUNTY",
"NCZ110":"COASTAL BRUNSWICK COUNTY",
"SCZ054":"COASTAL HORRY COUNTY",
"SCZ055":"INLAND GEORGETOWN",
"SCZ056":"COASTAL GEORGETOWN",
"SCZ058":"CENTRAL HORRY COUNTY",
"AMZ250":"Coastal Waters from Surf City NC to Cape Fear NC out 20 NM",
"AMZ252":"Coastal Waters from Cape Fear NC to Little River Inlet SC out 20 NM",
"AMZ254":"Coastal Waters from Little River Inlet SC to Murrells Inlet SC out 20 NM",
"AMZ256":"Coastal Waters from Murrells Inlet SC to South Santee River SC out 20 NM",
"AMZ270":"Offshore Waters from Surf City NC to Cape Fear NC out 20 to 40 NM",
"AMZ272":"Offshore Waters from Cape Fear NC to Little River Inlet SC out 20 to 40 NM",
"AMZ274":"Offshore Waters from Little River Inlet SC to Murrells Inlet SC out 20 to 40 NM",
"AMZ276":"Offshore Waters from Murrells Inlet  SC to South Santee River SC out 20 to 40 NM"
}
...
# *** GENERATING TEXT FOR KEYWORD 'ZONEORDER' ***
zone_order = { "NCZ105", "NCZ106", "NCZ107", "NCZ108", "NCZ110", "NCZ110", "SCZ054", "SCZ055", "SCZ056", "SCZ058", 
"AMZ250", "AMZ252", "AMZ254", "AMZ256", "AMZ270", "AMZ272", "AMZ274", "AMZ276" }
...
# *** GENERATING TEXT FOR KEYWORD 'COUNTYLIST' ***
county_list = {
"NCC141":"NCZ105,NCZ106",
"NCC129":"NCZ107,NCZ108",
"NCC019":"NCZ109,NCZ110",
"SCC051":"SCZ058,SCZ054",
"SCC043":"SCZ055,SCZ056"
}
...
# *** GENERATING TEXT FOR KEYWORD 'TIMEZONE' ***
tz = 5 # standard time utc offset (in hours, omit +/- signs)

#  Standard time ID (PST, AST ,etc)
# *** GENERATING TEXT FOR KEYWORD 'TIMEZONENAME' ***
tzid = "est" # standard time id (pst, ast, etc)
